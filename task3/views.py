...
def labtorg(request):
    context = {
        ...
        'menu': [
            {'url': '/', 'title': 'Главная'},
            {'url': '/reagents', 'title': 'Реагенты'},
            {'url': '/basket', 'title': 'Корзина'},
        ],
        'content': 'Добро пожаловать на страницу лабораторного оборудования!',
    }
    return render(request, 'third_task/labtorg.html', context)
...
def reagents(request):
    ...
    return render(request, 'third_task/reagents.html', context)
